...
html_markdown("Hello I am Ankit Computer Vision With OpenCV and Mediapipe",
...
if mode == modes[1]:
    ...
    face = st.sidebar.selectbox(
        "Face", options=["Run Video", 'Face Detector'])
...
with st.expander("About Me"):
    st.markdown("""<body><div>My name is<div/>
                <h2 style='color:blue'>Ankit Mishra<h2/>
                <div>I'am a student Goa University
                This is my first project with Streamlit<div/> <body/>""", unsafe_allow_html=True)
    st.write("""My Contact""")
    st.markdown("""<h3 style = 'color:blue'>+91-7004052008<h3/>""",
